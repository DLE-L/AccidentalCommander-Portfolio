...
{
    public sealed class SynergyMixedCommandRunModuleTests
    {
        [Test]
        public void BoundModule_UsesActualLivingCompanionForImmediateRound()
        {
            ...
            Assert.AreEqual(1.15f, PartyServiceAccess.ResolveCompanionAttackIntervalDivisor(fixture.Party, companion));
            Assert.AreEqual(1.15f, PartyServiceAccess.ResolveCompanionMoveSpeedMultiplier(fixture.Party, companion));
        }

        [Test]
        public void DownedTarget_IsRemovedUntilTheNextTimedRoundSnapshotsItsRevival()
        {
            using Fixture fixture = new Fixture();
            CompanionRuntime companion = fixture.AddCompanion("shield_guard", 40);
            MixedCommandRunModule module = fixture.CreateModule();
            ...
            module.Tick(1.0f);
            Assert.AreEqual(1.0f, PartyServiceAccess.ResolveCompanionAttackIntervalDivisor(fixture.Party, companion));

            SetProperty(companion, "IsDown", false);
            module.Tick(2.0f);
            Assert.AreEqual(1.0f, PartyServiceAccess.ResolveCompanionMoveSpeedMultiplier(fixture.Party, companion));
        ...
        [Test]
        public void BindingReplacement_ResetDisposeAndUnbind_LeaveOnlyTheCurrentModuleQueryable()
        {
            using Fixture fixture = new Fixture();
            CompanionRuntime companion = fixture.AddCompanion("shield_guard", 40);
            MixedCommandRunModule older = fixture.CreateModule();
            MixedCommandRunModule current = fixture.CreateModule();
            PartyServiceAccess.BindMixedCommandRunModule(fixture.Party, older);
            PartyServiceAccess.BindMixedCommandRunModule(fixture.Party, current);
            PartyServiceAccess.UnbindMixedCommandRunModule(fixture.Party, older);
            fixture.ActivateMixedCommand();
            ...
            current.Dispose();
            Assert.AreEqual(1.0f, PartyServiceAccess.ResolveCompanionAttackIntervalDivisor(fixture.Party, companion));
            PartyServiceAccess.UnbindMixedCommandRunModule(fixture.Party, current);
            Assert.AreEqual(1.0f, PartyServiceAccess.ResolveCompanionMoveSpeedMultiplier(fixture.Party, companion));
        }
        ...
        sealed class Fixture : IDisposable
        {
            ...
            {
                MixedCommandRunModule module = new MixedCommandRunModule(_services.Data, Triggers, Party);
                _modules.Add(module);
                return module;
            }
