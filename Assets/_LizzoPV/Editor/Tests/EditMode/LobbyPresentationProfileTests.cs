...
namespace Lizzo.PV.EditorTests
{
    public sealed class LobbyPresentationProfileTests
    {
        ...
        private static IEnumerable<CommanderVisualBinding> CreateCommanderBindings()
        {
            yield return new CommanderVisualBinding("commander_01", new SpriteAssetId(50));
        }
