...
namespace Lizzo.PV.EditorTests
{
    public sealed class CompanionRunModuleS4Tests
    {
        ...
        public void FourDeliveries_DirectResolvesImmediately_OthersDetachAndKeepSourceSnapshot()
        {
            ...
            Assert.That(firstAdvanceEvents.Count, Is.EqualTo(5));
            Assert.That(firstAdvanceEvents[0].Kind, Is.EqualTo(CompanionRunEventKind.EffectCommitted));
            Assert.That(firstAdvanceEvents[0].CompanionId, Is.EqualTo("direct"));
            Assert.That(firstAdvanceEvents[1].Kind, Is.EqualTo(CompanionRunEventKind.EffectResolved));
            Assert.That(firstAdvanceEvents[1].CompanionId, Is.EqualTo("direct"));
            Assert.That(firstAdvanceEvents[2].Kind, Is.EqualTo(CompanionRunEventKind.EffectCommitted));
            Assert.That(firstAdvanceEvents[2].CompanionId, Is.EqualTo("projectile"));
            Assert.That(firstAdvanceEvents[3].Kind, Is.EqualTo(CompanionRunEventKind.EffectCommitted));
            Assert.That(firstAdvanceEvents[3].CompanionId, Is.EqualTo("area"));
            Assert.That(firstAdvanceEvents[4].Kind, Is.EqualTo(CompanionRunEventKind.EffectCommitted));
            Assert.That(firstAdvanceEvents[4].CompanionId, Is.EqualTo("spawned"));
        ...
        public void PauseFreezesSquadAndDetachedProgress()
        {
            ...
            IReadOnlyList<CompanionRunEvent> committedEvents = module.DrainEvents();
            Assert.That(committedEvents.Count, Is.EqualTo(1));
            Assert.That(committedEvents[0].Kind, Is.EqualTo(CompanionRunEventKind.EffectCommitted));
