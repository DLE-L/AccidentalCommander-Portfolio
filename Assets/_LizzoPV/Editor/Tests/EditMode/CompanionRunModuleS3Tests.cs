...
namespace Lizzo.PV.EditorTests
{
    public sealed class CompanionRunModuleS3Tests
    {
        ...
        public void ExcursionSquad_ReflowsWithCommanderAndKeepsCommittedTargetUntilReturningToLatestAnchor()
        {
            ...
            Assert.That(afterAction.Squads[0].FormationAnchor.Y, Is.EqualTo(4.55f).Within(0.0001f));
            ...
            Assert.That(afterAction.Squads[0].FormationAnchor.Y, Is.EqualTo(7.55f).Within(0.0001f));
            ...
            Assert.That(
                ...
                Is.EqualTo(7.55f).Within(0.0001f));
        ...
        public void CancelActiveActions_SnapsActiveMembersToLatestAnchorsAndClearsState()
        {
            ...
            Assert.That(snapshot.ActiveMemberPosition.X, Is.EqualTo(-0.72f).Within(0.0001f));
            Assert.That(snapshot.ActiveMemberPosition.Y, Is.EqualTo(-0.25f).Within(0.0001f));
