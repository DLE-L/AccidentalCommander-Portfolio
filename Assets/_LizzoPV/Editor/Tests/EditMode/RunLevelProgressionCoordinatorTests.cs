...
namespace Lizzo.PV.Tests.EditMode
{
    public sealed class RunLevelProgressionCoordinatorTests
    {
        ...
        public void TutorialBaseline_ExposesCalibratedCurveSpawnAndEnemyValues()
        {
            ...
            Assert.That(TutorialCombatBaseline.ResolveActiveSpawnEdgeCount(3.0f), Is.EqualTo(4));
            Assert.That(TutorialCombatBaseline.ResolveActiveSpawnEdgeCount(19.0f), Is.EqualTo(4));
            Assert.That(TutorialCombatBaseline.ResolveActiveSpawnEdgeCount(50.0f), Is.EqualTo(4));
