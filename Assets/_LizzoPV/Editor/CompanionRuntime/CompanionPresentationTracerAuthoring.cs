...
namespace Lizzo.PV.Editor.CompanionRuntime
{
    public static class CompanionPresentationTracerAuthoring
    {
        ...
        [MenuItem("Lizzo/Companion Runtime/Rebuild S5 Sword Presentation Tracer")]
        public static void RebuildS5SwordPresentationTracer()
        {
            ...
            CreateMemberPrefab(
                ...
                2,
                true);
            CreateSquadRootPrefab();

            AssetDatabase.SaveAssets();
            Debug.Log("[CompanionPresentationTracerAuthoring] S5 sword presentation tracer rebuilt.");
        }
        ...
        private static void CreateSquadRootPrefab()
        {
            GameObject basePrefab = LoadRequired<GameObject>(BaseMemberPrefabPath);
            GameObject promotedPrefab = LoadRequired<GameObject>(PromotedMemberPrefabPath);
            GameObject root = new GameObject("SwordSquadRoot");
            try
            {
                ...
                rootObject.FindProperty("_companionId").stringValue = "sword_soldier";
                ...
                SavePrefab(root, SquadRootPrefabPath);
            }
            finally
            {
                UnityEngine.Object.DestroyImmediate(root);
