...
namespace Lizzo.PV.Gameplay.Presentation.Editor
{
    public abstract class PresentationSetEditor : UnityEditor.Editor
    {
    ...
    public sealed class FeedbackPresentationCatalogEditor : PresentationSetEditor
    {
    }

    [CustomEditor(typeof(UnitPresentationSet))]
    public sealed class UnitPresentationSetEditor : PresentationSetEditor
    {
    }
}
