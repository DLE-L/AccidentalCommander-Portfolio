...
namespace Lizzo.PV.Gameplay.Result
{
    ...
    public sealed class GameplayResultMainView : MonoBehaviour
    {
        ...
        [SerializeField]
        private TMP_Text _synergySectionLabelText;

        [SerializeField]
        private TMP_Text _synergyNameText;

        [SerializeField]
        private Image[] _synergyMemberIcons = new Image[SynergyMemberCount];

        [SerializeField]
        private GameObject _synergyMembersRoot;

        [SerializeField]
        private TMP_Text _synergyMembersText;

        [SerializeField]
        private GameObject _synergyEffectRoot;

        [SerializeField]
        private TMP_Text _synergyEffectText;

        [SerializeField]
        private TMP_Text _finalLegionHeaderText;

        [SerializeField]
        private LegionSlotBinding[] _legionSlots = new LegionSlotBinding[LegionSlotCount];

        [SerializeField]
        private Sprite[] _legionIconSprites = new Sprite[LegionSlotCount];

        [SerializeField]
        private Button _damageStatisticsButton;

        [SerializeField]
        private TMP_Text _damageStatisticsButtonText;
