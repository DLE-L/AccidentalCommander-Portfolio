...
namespace Lizzo.PV.Gameplay.Visuals
{
    public sealed class HitFlash : MonoBehaviour
    {
        ...
        [SerializeField, Min(0.01f)] private float _shakeSeconds = 0.14f;
        [SerializeField, Min(0f)] private float _shakeDistance = 0.045f;
        ...
        public void Play()
        {
            ...
            _remaining = Mathf.Max(0.01f, _flashSeconds);
            _activationSequence++;
            _flashActive = true;
        ...
        public void PlayShake()
        {
            ...
            _shakeRemaining = Mathf.Max(0.01f, _shakeSeconds);
        }
        ...
        private void UpdateShake()
        {
            ...
            float x = Mathf.Sin(Time.time * 95.0f) * Mathf.Max(0f, _shakeDistance);
