...
namespace Lizzo.PV.Gameplay.CardOffer
{
    ...
    public static class CompanionPassiveCatalog
    {
        private static readonly CompanionPassiveCatalogEntry[] Entries =
        {
            ...
            Role(CardKind.PassiveHerbalistWideFlask, "passive_herbalist_wide_flask", "넓은 약병", "약초병 약병 범위 +30%", "field_herbalist", "area_radius_multiplier", 1.30f),
            Role(CardKind.PassiveHerbalistConcentratedMixture, "passive_herbalist_concentrated_mixture", "농축 혼합물", "취약 효과량 +15%", "field_herbalist", "status_magnitude_bonus", 0.15f),
            ...
            Role(CardKind.PassiveHerbalistReactiveCompound, "passive_herbalist_reactive_compound", "반응성 화합물", "취약 확산 대상 +2", "field_herbalist", "status_target_bonus", 2.0f),
            ...
            Role(CardKind.PassiveWraithWidePatrol, "passive_wraith_wide_patrol", "넓은 순찰", "망령기사 탐색 범위 +35%", "wraith_knight", "acquisition_range_multiplier", 1.35f),
            ...
            Role(CardKind.PassiveNecromancerStrongPull, "passive_necromancer_strong_pull", "강한 인력", "저주 당기기 거리 +40%", "necromancer", "forced_movement_multiplier", 1.40f),
