...
namespace Lizzo.PV.Gameplay.Result
{
    ...
    public sealed class GameplayResultBuildSummaryView : MonoBehaviour
    {
        ...
        [SerializeField]
        private CompanionSlotBinding[] _companionSlots = new CompanionSlotBinding[CompanionCount];

        [SerializeField]
        private PassiveSlotBinding[] _passiveSlots = new PassiveSlotBinding[PassiveCount];

        [SerializeField]
        private TMP_Text _synergySummaryText;
        ...
        {
            if (_companionSlots == null
                || _companionSlots.Length != CompanionCount
                || _synergySummaryText == null
                || HasInvalidCompanionBinding()
                || (requirePassiveAuthoring
                    && (_passiveSlots == null
                        || _passiveSlots.Length != PassiveCount
        ...
        private bool HasInvalidCompanionBinding()
        {
            for (int i = 0; i < _companionSlots.Length; i++)
            {
                ...
                if (binding == null
                    || binding.Root == null
                    || binding.ActiveVisual == null
                    || binding.EmptyVisual == null
                    || binding.Icon == null
