...
namespace Lizzo.PV.Data
{
    public sealed partial class LocalDataProvider
    {
        private void SeedFallbackEnemies()
        {
            ...
            AddEnemy(Define.RED_CHARGER_ID, "red_charger", "붉은 돌격수", "Units/Enemies/RedCharger", "normal", 240, 16, 1.0f, 1.0f, 1.35f, 150.0f, 5.0f, 0.9f, 0.0f, 0.0f, 1.4f, new Color(1.0f, 0.05f, 0.05f, 1.0f), 210, chargeAttack: 24);
